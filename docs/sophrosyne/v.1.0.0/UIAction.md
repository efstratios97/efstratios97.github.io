...
<img src="/sophrosyne/v.1.0.0/_media/ACTIONS_TYPES.png" alt="ACTIONS_TYPES" style="max-height:15vh">
</div>
...
<div style="text-align: center">
<img src="/sophrosyne/v.1.0.0/_media/ACTIONS_OVERVIEW.png" alt="Action Overview" style="max-height:50vh">
</div>
...
<div style="text-align: center">
<img src="/sophrosyne/v.1.0.0/_media/ACTIONS_CREATION_FORM.png" alt="ACTIONS_CREATION_FORM" style="max-height:50vh">
</div>
...
<table style="width: 100%; border-collapse: collapse; margin-top: 20px;">
  ...
  <tr>
    ...
    <td style="padding: 10px; text-align: left; border-bottom: 1px solid #ddd;">When the respective action gets triggered an additionally confirmation by an user is necessary. Further info <a href="#/sophrosyne/v.1.0.0/WebUI?id=action-confirmation-requests">here</a></td>
...
<div style="text-align: center">
<img src="/sophrosyne/v.1.0.0/_media/ACTIONS_EXECUTION.png" alt="ACTIONS_CREATION_FORM" style="max-height:50vh">
</div>
...
<div style="text-align: center">
<img src="/sophrosyne/v.1.0.0/_media/DYNAMIC_ACTIONS_CREATION_FORM.png" alt="DYNAMIC_ACTIONS_CREATION_FORM" style="max-height:50vh">
</div>
...
<div style="text-align: center">
<img src="/sophrosyne/v.1.0.0/_media/DYNAMIC_ACTIONS_EXECUTION.png" alt="DYNAMIC_ACTIONS_EXECUTION" style="max-height:50vh">
</div>

### Complex Commands

If you need more complex commands with multiple arguments, you have to encapsulated your commands between `""`:
<div style="text-align: center">
<img src="/sophrosyne/v.1.0.0/_media/COMMAND_WITH_QUOTES.png" alt="COMMAND_WITH_QUOTES" style="max-height:50vh">
</div>

If your complex command incorporates `""`, you have to encapsulated your command between `''`:
<div style="text-align: center">
<img src="/sophrosyne/v.1.0.0/_media/COMMAND_WITH_QUOTES_INCORPORATED.png" alt="COMMAND_WITH_QUOTES_INCORPORATED" style="max-height:50vh">
</div>
...
<div style="text-align: center">
<img src="/sophrosyne/v.1.0.0/_media/ACTION_CONFIRMATION_OVERVIEW.png" alt="ACTION_CONFIRMATION_OVERVIEW" style="max-height:50vh">
</div>
