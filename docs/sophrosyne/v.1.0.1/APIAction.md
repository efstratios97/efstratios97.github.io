...
- `201` – Action triggered and awaits confirmation.
- `400` – Invalid ID supplied.
- `401` – Unauthorized.
- `404` – Action not found.
- `406` - Action is muted.
- `409` - Action is already running.
...
* `200` – Successful execution.
* `201` - Dynamic Action triggered and awaits confirmation
* `400` – Invalid ID supplied.
* `401` – Unauthorized.
* `404` – Dynamic Action not found.
* `406` - Dynamic Action is muted
* `409` - Dynamic Action with identical parameters is already running
